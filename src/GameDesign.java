...
public class GameDesign extends javax.swing.JFrame {
    ...
    public GameDesign() {
         initComponents();
         this.j = new GameLogic(0, 0, 0);
         startGame();
    }
    
    /**
     * You have to call the start game method located in LogicaGame, passing through parameters
     * the matrix and jPanel4
     * 
     * We will call the method to restart all the buttons.
     */
    public void startGame(){
         j.startGame(matriz, jPanel1);
         clearButtons();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tictactoe/logo.png"))); // NOI18N
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        j.playerRoll(jButton9, 2, 2, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        j.playerRoll(jButton8, 2, 1, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        j.playerRoll(jButton7, 2, 0, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        j.playerRoll(jButton6, 1, 2, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        j.playerRoll(jButton5, 1, 1, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        j.playerRoll(jButton4, 1, 0, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        j.playerRoll(jButton3, 0, 2, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        j.playerRoll(jButton2, 0, 1, matriz, jPanel4, pX, pO);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        j.playerRoll(jButton1, 0, 0, matriz, jPanel4, pX, pO);
